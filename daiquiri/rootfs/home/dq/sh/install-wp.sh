...
maybe_copy "/tmp/wp-config-sample.php" "${WP}/wp-config.php"

# replace_in_wpconfig "DAIQUIRI_URL" "http://$(get_container_ip "dq-daiquiri")"
replace_in_wpconfig "DAIQUIRI_URL" "http://localhost:80"
replace_in_wpconfig "WP_HOME" "http://localhost:9280/cms"
replace_in_wpconfig "WP_SITEURL" "http://localhost:9280/cms"
